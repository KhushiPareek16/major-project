...
def OD():
    ...
    with open(r"C:\Users\user\Desktop\Blind Person Helper\coco.names", 'r') as f:
    ...
    net = cv2.dnn.readNet(r"C:\Users\user\Desktop\Blind Person Helper\yolov3.weights",r"C:\Users\user\Desktop\Blind Person Helper\yolov3.cfg")
    ...
    # release resources"C:\\Users\\user\\Downloads\\OBJECT DETECTION AND COUNTING\\yolov3.weights","C:\\Users\\user\\Downloads\\OBJECT DETECTION AND COUNTING\\yolov3.cfg.txt"
    view rawyolo_opencv_part5.py hosted with ❤ by GitHub'''
#OD()