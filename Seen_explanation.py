...
def se():
    ...
    #_, frame = cam.read()
    #frame = cv2.imread(r"C:\Users\user\Downloads\qwiklabs-gcp-04-21facdf36645-ff695f18ecd0.json") # Ye comment kiya hua h
    
    credentials = service_account.Credentials.from_service_account_file(r"C:\Users\user\Downloads\qwiklabs-gcp-01-9c8d86305235-3b4bb306ed03.json")
    while True:        
